                                ...
                                public void onResponse(String response) {
                                    ...
                                    try {
                                        ...
                                        if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                            Toast.makeText(Changepasswd.this, "Updated", Toast.LENGTH_SHORT).show();
                                            Intent i = new Intent(getApplicationContext(), Login.class);
                                            startActivity(i);

                                        } else if (jsonObj.getString("status").equalsIgnoreCase("No")) {
                                            Toast.makeText(Changepasswd.this, "Already exist", Toast.LENGTH_SHORT).show();
                                            Intent i = new Intent(getApplicationContext(), home.class);
                                            startActivity(i);

                                        } else if (jsonObj.getString("status").equalsIgnoreCase("mismatch")) {
                                            Toast.makeText(Changepasswd.this, "Password mismatch", Toast.LENGTH_SHORT).show();
                                            Intent i = new Intent(getApplicationContext(), home.class);
                                            startActivity(i);

                                        } else if (jsonObj.getString("status").equalsIgnoreCase("error")) {
                                            Toast.makeText(Changepasswd.this, "Password error", Toast.LENGTH_SHORT).show();
                                            Intent i = new Intent(getApplicationContext(), home.class);
                                            startActivity(i);
