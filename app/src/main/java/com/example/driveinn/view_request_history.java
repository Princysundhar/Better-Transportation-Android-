...
public class view_request_history extends AppCompatActivity {
    ListView li;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sh.getString("ip", "");
        url = sh.getString("url", "") + "/android_request_history";
                        ...
                        try {
                            ...
                            if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                ...
                                for(int i=0;i<js.length();i++)
                                {
                                    ...
                                    hid[i]=u.getString("hid");
                                    requests[i]=u.getString("requests");
                                ...
                                li.setAdapter(new custom_view_request_history(getApplicationContext(),hid,requests,amount,date,payment_mode));
