...
public class ViewRatings extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        li = findViewById(R.id.viewrating);
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if (jsonObj.getString("status").equalsIgnoreCase("ok")) {
                                ...
                                worker_info=new String[js.length()];
                                ...
                                for(int i=0;i<js.length();i++)
                                {
                                    ...
                                    worker_info[i]=u.getString("worker_info");
                                    userinfo[i]=u.getString("userinfo");
                                ...
                                li.setAdapter(new CustomViewRating(getApplicationContext(),rid,rating,review,date,worker_info,userinfo));
